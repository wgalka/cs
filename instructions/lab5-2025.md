...
`virtual` - <textarea id="polimorphism" cols=70 rows=10></textarea>

`sealed` - <textarea id="polimorphism" cols=70 rows=10></textarea>

`override` - <textarea id="polimorphism" cols=70 rows=10></textarea>
...
>Stwórz klary reprezentujące różne rodzaje zwierząt. Każde zwierzę ma metodę WydajDzwiek(), która generuje dźwięk charakterystyczny dla danego gatunku. Dodaj również metodę Jedz(), która nie będzie wirtualna.
