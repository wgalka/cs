...
Wymień elementy niedziedziczone przez klasy pochodne oraz je scharakteryzuj (kiedy są wywoływane, do czego służą <mark>szczególnie konstruktory statyczne</mark>):
